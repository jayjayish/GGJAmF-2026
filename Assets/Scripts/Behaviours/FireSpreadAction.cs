...
public partial class FireSpreadAction : Action
{
    ...
    protected override Status OnStart()
    {
        ...
        var ball2 = ProjectileManager.SpawnProjectile(Data.GlobalTypes.ProjectileTypes.TestCircle, Agent.Value.transform.position, 0);
        var ball3 = ProjectileManager.SpawnProjectile(Data.GlobalTypes.ProjectileTypes.TestCircle, Agent.Value.transform.position, 0);
